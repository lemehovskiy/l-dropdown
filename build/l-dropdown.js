...
(function ($) {
    var LDropdown = function () {
        function LDropdown(element, options) {
            _classCallCheck(this, LDropdown);
        ...
        _createClass(LDropdown, [{
            ...
            key: 'subscribeCloseByDocumentClick',
            value: function subscribeCloseByDocumentClick() {
                var self = this;
    ...
    $.fn.lDropdown = function () {
        var $this = this,
            ...
            ret = void 0;
        for (i = 0; i < length; i++) {
            if ((typeof opt === 'undefined' ? 'undefined' : _typeof(opt)) == 'object' || typeof opt == 'undefined') $this[i].l_dropdown = new LDropdown($this[i], opt);else ret = $this[i].l_dropdown[opt].apply($this[i].l_dropdown, args);
